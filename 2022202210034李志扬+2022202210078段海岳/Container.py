...
class Container(object):
    ...
    def save_encasement_as_file(self,num : int,rate,time):
        file = open(f"data/{num}_encasement.csv",'w',encoding='utf-8')
        ...
        file.write(f"fill_rate,,,,,,{rate}\n")
        file.write(f"execution_time,,,,,,{time}\n")
        file.close()
